        ...
        return <Container>
            <Header style={Style.navigation}>
                ...
                <View style={Style.actionBarMiddle}>
                    <Text style={Style.actionBarText}>{'Local Shopping'.toUpperCase()}</Text>
                </View>
                ...
                <ImageBackground source={require('@Asset/images/bg.png')} imageStyle={'cover'} style={Styles.slider}>
                    ...
                    <View style={Styles.sectionGrey}>
                        <View style={Styles.headerBg}>
                            ...
                            <Text style={Styles.sHeader}>{'Ad Local Shopping'.toUpperCase()}</Text>
                            <Right>
                            ...
                            <View style={Styles.btnList}>
                                <TouchableOpacity style={Styles.btnCityMain} onPress={() => {
                                    ...
                                    <View style={Styles.btnCityLocationMain}>
                                        <Text style={Styles.btnCityText}>Electronics</Text>
                                        <Text style={Styles.btnCityCount}>1200</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                            <View style={Styles.btnList}>
                                <TouchableOpacity style={Styles.btnCity} onPress={() => {
                                    ...
                                    <View style={Styles.btnCityLocation}>
                                        <Text style={Styles.btnCityText}>Home Application</Text>
                                        <Text style={Styles.btnCityCount}>1200</Text>
                                    </View>
                                </TouchableOpacity>
                                <TouchableOpacity style={Styles.btnCity} onPress={() => {
                                    ...
                                    <View style={Styles.btnCityBg} />
                                    <View style={Styles.btnCityLocation}>
                                        <Text style={Styles.btnCityText}>Wardrobes</Text>
                                        <Text style={Styles.btnCityCount}>4200</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                        </View>
                        ...
                        <View style={Styles.city}>
                            <View style={Styles.btnList}>
                                <TouchableOpacity style={Styles.btnCity} onPress={() => {
                                    ...
                                    <View style={Styles.btnCityBg} />
                                    <View style={Styles.btnCityLocation}>
                                        <Text style={Styles.btnCityText}>Foods & Beverages</Text>
                                        <Text style={Styles.btnCityCount}>320000</Text>
                                    </View>
                                </TouchableOpacity>
                                <TouchableOpacity style={Styles.btnCity} onPress={() => {
                                    NavigationService.navigate('PublicShopAds')
                                    ...
                                    <View style={Styles.btnCityBg} />
                                    <View style={Styles.btnCityLocation}>
                                        <Text style={Styles.btnCityText}>Home & Furnitures</Text>
                                        <Text style={Styles.btnCityCount}>500</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
                            <View style={Styles.btnList}>
                                <TouchableOpacity style={Styles.btnCityMain} onPress={() => {
                                    ...
                                    <View style={Styles.btnCityBgMain} />
                                    <View style={Styles.btnCityLocationMain}>
                                        <Text style={Styles.btnCityText}>Sports</Text>
                                        <Text style={Styles.btnCityCount}>1200</Text>
                                    </View>
                                </TouchableOpacity>
                            </View>
