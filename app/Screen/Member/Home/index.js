                    ...
                    <ImageBackground source={require('@Asset/images/bg_in.png')} imageStyle={'cover'} style={Styles.crv}>
                        ...
                        <View style={Styles.btnLayout}>
                            ...
                            <TouchableOpacity style={Styles.btnBoxBot} onPress={() => {
                                ...
                                <Image source={require('@Asset/images/social_media.png')} style={Styles.btnImg} />
                                <Text style={Styles.btnText}>Social Media</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={Styles.btnBoxBot} onPress={() => {
                                NavigationService.navigate('MemberSettings')
                            }}>
                            ...
                            <TouchableOpacity style={Styles.btnBoxBot} onPress={() => {
                                ...
                                <Image source={require('@Asset/images/chat_ico.png')} style={Styles.btnImg} />
                                <Text style={Styles.btnText}>Chat</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={Styles.btnBoxBot} onPress={() => {
                                NavigationService.navigate('MemberSettings')
                            }}>
                                <Image source={require('@Asset/images/notification_ico.png')} style={Styles.btnImg} />
